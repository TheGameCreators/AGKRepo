...
NSString * const iRateiOSAppStoreURLFormat = @"http://itunes.apple.com/app/id%lu";
NSString * const iRateMacAppStoreURLFormat = @"macappstore://itunes.apple.com/app/id%lu";
...
- (NSURL *)ratingsURL
{
	...
	return [NSURL URLWithString:[NSString stringWithFormat:iRateMacAppStoreURLFormat, (unsigned long)appStoreID]];
