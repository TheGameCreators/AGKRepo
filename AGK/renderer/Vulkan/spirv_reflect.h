...
typedef enum SpvReflectFormat {
  ...
  SPV_REFLECT_FORMAT_R32G32B32A32_uint32_t   = 107, // = VK_FORMAT_R32G32B32A32_uint32_t
...
enum {
  SPV_REFLECT_MAX_ARRAY_DIMS                    = 8,
  SPV_REFLECT_MAX_DESCRIPTOR_SETS               = 16,
};
