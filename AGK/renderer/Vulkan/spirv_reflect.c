...
)
{
  ...
  if (p_type->type_flags & SPV_REFLECT_TYPE_FLAG_VECTOR) {
    ...
    if (p_type->type_flags & SPV_REFLECT_TYPE_FLAG_FLOAT) {
      ...
      switch (component_count) {
        case 2: *p_format = signedness ? SPV_REFLECT_FORMAT_R32G32_SINT : SPV_REFLECT_FORMAT_R32G32_uint32_t; break;
        case 3: *p_format = signedness ? SPV_REFLECT_FORMAT_R32G32B32_SINT : SPV_REFLECT_FORMAT_R32G32B32_uint32_t; break;
        case 4: *p_format = signedness ? SPV_REFLECT_FORMAT_R32G32B32A32_SINT : SPV_REFLECT_FORMAT_R32G32B32A32_uint32_t; break;
      }
      result = SPV_REFLECT_RESULT_SUCCESS;
    }
  }
    ...
    *p_format = SPV_REFLECT_FORMAT_R32_SFLOAT;
    ...
    if (signedness) {
      ...
      *p_format = SPV_REFLECT_FORMAT_R32_uint32_t;
      result = SPV_REFLECT_RESULT_SUCCESS;
    }
  }
