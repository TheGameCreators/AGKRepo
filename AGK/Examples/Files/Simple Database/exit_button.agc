...
function display_exit()
	...
	SetSpriteGroup(exit_button,2)
	SetSpriteAnimation(exit_button,256,256,2)
	SetSpriteSize(exit_button,100,100)
...
function check_exit()
	...
	if GetPointerPressed() // Check if the the screen has been touched
		if GetSpriteHitGroup(2,getpointerx(),getpointery()) = exit_button // check if the exit button was touched
