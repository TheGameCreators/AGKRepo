...
function maketext()
	...
	CreateText(1, "Creating a SkyBox")
	...
	CreateText(3, "Demo to show built-in SkyBox features" ) // Display some simple instructions
	...
	CreateText(4, "Buttons change the colour of the Sky, Horizon, and Sun." ) // Display some simple instructions
