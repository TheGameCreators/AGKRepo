...
function maketext()
	...
	CreateText(3, "Example of how to control the 3D camera" ) // Display some simple instructions
	...
	CreateText(4, "Big buttons move, Small buttons: 1st person, 3rd person & Cinematic." ) // Display some simple instructions
