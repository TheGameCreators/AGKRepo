...
function isIE7() { return /msie 7/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent); }
function isIE8() { return /msie 8/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent); }
  ...
  function sourceDecorator(options) {
    ...
    if (options['hashComments']) {
      if (options['cStyleComments']) {
        ...
        shortcutStylePatterns.push(
            [PR_KEYWORD, /^#(?:(?:define|elif|else|endif|error|ifdef|include|ifndef|line|pragma|undef|warning)\b|[^\r\n]*)/,
             null, '#']);
        fallthroughStylePatterns.push(
            [PR_STRING,
             /^<(?:(?:(?:\.\.\/)*|\/?)(?:[\w-]+(?:\/[\w-]+)+)?[\w-]+\.h|[a-z]\w*)>/,
  ...
  function prettyPrint(opt_whenDone) {
    ...
    function replaceWithPrettyPrintedHtml() {
      ...
      if (!isRawContent(cs)) {
        ...
        cs.innerHTML = '<pre style="white-space:inherit; padding:0px; margin:0px; border:none; background-color:inherit;line-height:inherit;font-family:inherit;font-size:inherit;color:inherit;">'+newContent+'</pre>';
      } else {
      ...
      // down rendering.
      if (( isIE6 || isIE7() || isIE8() ) && cs.tagName === 'PRE') {
