...
{
    if ( [AGKViewController isOpen] ) [[AGKViewController getSharedViewController] setInactive];
	agk::AppPausing();
#ifndef USE_METAL
    glFinish();
#endif
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    agk::AppResuming();
	agk::Resumed();
    if ( [AGKViewController isOpen] ) [[AGKViewController getSharedViewController] setActive];
}
...
@implementation AGKAppDelegate ( Facebook )
