...
#define _WIN32_WINNT 0x0601 // must be 0x0601 for windows 7 support
                     ...
                     int       nCmdShow)
{
	...
	HWND hWnd = 0;
	if ( App.m_sProgram.GetRendererMode() != AGK_RENDERER_MODE_NONE )
	{
		...
		hWnd = CreateWin32Window( hInstance, width, height, szTitle, -1, -1, fullscreen==1 );
