...
/*
			...
			if (pref.bEnableCustomStyle) {
				...
				ImGui::ColorEdit3("main", &rgb.x, ImGuiColorEditFlags_NoAlpha | ImGuiColorEditFlags_HSV);
				...
				ImGui::ColorConvertHSVtoRGB(hue / 255.f, col_text_sat, col_text_val, rgb.x, rgb.y, rgb.z);
				ImGui::ColorEdit3("text", &rgb.x);
