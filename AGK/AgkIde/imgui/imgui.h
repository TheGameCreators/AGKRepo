...
enum ImGuiTabBarFlags_
{
    ...
    ImGuiTabBarFlags_FittingPolicyDefault_          = ImGuiTabBarFlags_FittingPolicyScroll //PE: changed default. ImGuiTabBarFlags_FittingPolicyResizeDown
};
...
enum ImGuiConfigFlags_
{
	...
	// PE:
	ImGuiConfigFlags_DockNoCollapsButton = 1 << 24   //
};
